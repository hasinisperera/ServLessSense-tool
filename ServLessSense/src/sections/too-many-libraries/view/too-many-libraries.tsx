        ...
        <CardHeader 
          title={
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-semibold">{SMELLS.libraries}</h3>
              <h4 className="text-l">There are libraries imported but are not being used or only a small part of a large library is being used.</h4>
