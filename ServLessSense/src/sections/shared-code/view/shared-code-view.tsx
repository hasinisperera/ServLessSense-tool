        ...
        <CardHeader 
          title={
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-semibold">{SMELLS.shared}</h3>
              <h4 className="text-l">There is code shared across multiple functions making a strong coupling between microservices and tying new releases together.</h4>
          ...
          {viewMode === 'tree' ? (
            ...
            <TableContainer component={Paper}>
              <Table size='medium'>
                <TableHead>
               <TableRow>
                 <TableCell style={{ width: 30 }}>File Path</TableCell>
                 <TableCell style={{ width: '50%' }}>Code</TableCell>
                 </TableRow>
                </TableHead>
                <TableBody>
                  {methodDetails
